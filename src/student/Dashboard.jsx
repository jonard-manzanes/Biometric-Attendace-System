            ...
            <div key={cls.id} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
              <div className="p-4">
                ...
                <button
                  ...
                  className="w-full mt-4 bg-emerald-500 hover:bg-emerald-600 text-white py-2 px-4 rounded text-sm transition-colors duration-200"
                >
                  Join Class
                </button>
